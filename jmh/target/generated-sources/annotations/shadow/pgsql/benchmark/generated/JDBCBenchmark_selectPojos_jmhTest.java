...
import shadow.pgsql.benchmark.generated.JDBCBenchmark_jmhType;
@Generated("org.openjdk.jmh.generators.core.BenchmarkGenerator")
public final class JDBCBenchmark_selectPojos_jmhTest {
    ...
    public BenchmarkTaskResult selectPojos_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            JDBCBenchmark_jmhType l_jdbcbenchmark0_0 = _jmh_tryInit_f_jdbcbenchmark0_0(control, threadParams);
            ...
            while (control.warmupShouldWait) {
                l_blackhole1_1.consume(l_jdbcbenchmark0_0.selectPojos());
                res.allOps++;
            }

            selectPojos_thrpt_jmhStub(control, res, l_jdbcbenchmark0_0, l_blackhole1_1);
    ...
    public void selectPojos_thrpt_jmhStub(InfraControl control, RawResults result, JDBCBenchmark_jmhType l_jdbcbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult selectPojos_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            selectPojos_avgt_jmhStub(control, res, l_jdbcbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_jdbcbenchmark0_0.selectPojos());
    ...
    public void selectPojos_avgt_jmhStub(InfraControl control, RawResults result, JDBCBenchmark_jmhType l_jdbcbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long operations = 0;
        long realTime = 0;
        result.startTime = System.nanoTime();
        do {
    ...
    public BenchmarkTaskResult selectPojos_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            selectPojos_sample_jmhStub(control, res, buffer, targetSamples, opsPerInv, batchSize, l_jdbcbenchmark0_0, l_blackhole1_1);
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
                    l_blackhole1_1.consume(l_jdbcbenchmark0_0.selectPojos());
    ...
    public void selectPojos_sample_jmhStub(InfraControl control, RawResults result, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JDBCBenchmark_jmhType l_jdbcbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult selectPojos_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = control.iterationParams.getBatchSize();
            selectPojos_ss_jmhStub(control, batchSize, res, l_jdbcbenchmark0_0, l_blackhole1_1);
            control.preTearDown();
    ...
    public void selectPojos_ss_jmhStub(InfraControl control, int batchSize, RawResults result, JDBCBenchmark_jmhType l_jdbcbenchmark0_0, Blackhole_jmhType l_blackhole1_1) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    JDBCBenchmark_jmhType f_jdbcbenchmark0_0;
    
    JDBCBenchmark_jmhType _jmh_tryInit_f_jdbcbenchmark0_0(InfraControl control, ThreadParams threadParams) throws Throwable {
        JDBCBenchmark_jmhType val = f_jdbcbenchmark0_0;
        if (val == null) {
            val = new JDBCBenchmark_jmhType();
            val.setup();
            f_jdbcbenchmark0_0 = val;
        }
        return val;
    }
